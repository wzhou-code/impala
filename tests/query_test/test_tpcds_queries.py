...
class TestTpcdsQueryForJdbcTables(ImpalaTestSuite):
  ...
  def add_test_dimensions(cls):
    ...
    # For exhaustive test on Jenkins, '--exploration_strategy' is not set as 'exhaustive'
    # somehow. The workaround is to get exploration strategy from environment variable
